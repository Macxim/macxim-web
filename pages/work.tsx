      ...
      <main className="flex flex-col items-center max-w-6xl px-8 lg:p-0 mb-24">
        ...
        <section className="w-full mt-6 sm:mt-32 flex-1 p-[0.5px] text-2xl leading-normal rounded-md shadow-sm bg-gradient-to-l from-zinc-50 via-zinc-300 to-zinc-100 ">
          <div className="p-6 border rounded-md md:p-8 bg-white/90 backdrop-blur-sm border-zinc-900/5">
            <h1 className="mb-4 text-4xl">Work & projects</h1>

            {allProjectsData ? (
              <ul role="list" className="grid grid-cols-2 gap-6 mt-6 md:grid-cols-3 lg:grid-cols-4">
                {allProjectsData.map(({ id, title, thumb }) => (
                  <li className="flex flex-col col-span-1 overflow-hidden text-center bg-white rounded-md group relative" key={id}>
                    <Link href={`projects/${id}`}>
                      ...
                      <div className="text-white left-0 top-0 group-hover:visible absolute w-full h-full bg-gradient-to-bl from-zinc-700 via-zinc-900/[96%] to-black invisible flex items-center justify-center transition ease-in-out duration-100">
                        ...
                        <svg className="absolute bottom-8 right-8 w-6 h-6 -rotate-12" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
