...
export default function Home() {
  return (
    <>
      ...
      <main className="flex flex-col items-center max-w-4xl px-8 overflow-x-hidden overflow-y-auto lg:p-0">
        ...
        <section className="flex-1 p-[0.5px] text-2xl leading-normal rounded-md shadow-sm bg-gradient-to-l from-zinc-50 via-zinc-300 to-zinc-100 ">
          <div className="p-6 border rounded-md md:p-8 bg-white/90 backdrop-blur-sm border-zinc-900/5">
            <img src="/maxime-laforet.jpg" alt="A picture of Maxime Laforet" className="w-24 h-24 mb-6 ease-in border-4 border-white rounded-full shadow-md" />
            ...
            <div className="flex justify-between mt-8">
              ...
              <p className="text-sm text-zinc-600 rounded-lg px-2 py-0.5 bg-zinc-50 border border-zinc-100">Last updated on <span className="font-semibold text-zinc-900"><time dateTime="2023-01-12" title="Thursday the 12th of January, 2023">2023-01-12</time></span></p>
            </div>
